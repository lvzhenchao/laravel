...
<script async="" src="cpc_new.php"></script>
<link rel="stylesheet" type="text/css" href="css4/index.css" media="all">
</head>
...
<script src="js4/s.js" async="" type="text/javascript"></script><script src="js4/adv.js"></script><script src="js4/mvl.js" async="" type="text/javascript"></script><script type="text/javascript">
...
<script src="js4/pagetop2015_0827.js" charset="gb2312" type="text/javascript"></script>
<script src="js4/dd.menu-aim.js" charset="gb2312" type="text/javascript"></script>
	...
	<li><a target="_top" href="http://e.dangdang.com/touch/special/goldenIP/index.html" name="mydd_7" dd_name="原创征文">原创征文</a></li>
        ...
        <li class="my_dd"><a class="menu_btn" target="_top" href="http://myhome.dangdang.com/" name="我的当当" dd_name="我的当当" id="a_myddchannel" onmouseover="showgaoji('a_myddchannel','__ddnav_mydd')" onmouseout="hideotherchannel('a_myddchannel','__ddnav_mydd');">我的当当</a>
            <ul class="ddnewhead_gcard_list" id="__ddnav_mydd" onmouseover="showgaoji('a_myddchannel','__ddnav_mydd')" onmouseout="hideotherchannel('a_myddchannel','__ddnav_mydd');">
                ...
                <li><a target="_top" href="{{ URL('/mycar') }}" name="mydd_8" dd_name="新_购物车" rel="nofollow">购物车</a></li>		
                ...
                <li><a target="_top" href="{{ URL('/res') }}" name="mydd_5" dd_name="我的余额1" rel="nofollow">我的余额</a></li>
                <li><a target="_top" href="{{ URL('/disc') }}" name="mydd_4" dd_name="我的评论" rel="nofollow">我的评论</a></li>
...
<!--CreateDate  2016-09-28 11:00:01--><div style="position: relative;" class="logo_line_out">
<div class="logo_line" dd_name="搜索框">
    <div class="logo"><img src="{{ asset('image4/ddlogonew.gif') }}" usemap="#logo_link">
            ...
            <input value="" class="text gray" name="key" id="key_S" autocomplete="off" onclick="key_onclick(event);" onfocus="key_onfocus(event);" onblur="key_onblur();" onbeforepaste="onpaste_search();" type="text"><a href="javascript:void(0);" onclick="clearkeys();" class="del-keywords"></a><span class="select" onmouseover="allCategoryShow();" onmouseleave="allCategoryHide();" onmouseout="if(&quot;\v&quot;!=&quot;v&quot;){ allCategoryHide();}"><span id="Show_Category_Name" dd_name="全部分类">全部分类</span><span class="icon"></span>
                <div id="search_all_category" class="select_pop" style="height: 0px; padding: 0px; border-width: 0px;" dd_name="搜索分类">
                    <a href="javascript:void(0);" onclick="selectCategory('',this);"><span id="Show_Category_Name" dd_name="全部分类">全部分类</span></a>
                                        ...
                                        <a href="http://newaccount.dangdang.com/payhistory/01.00.00.00.00.00" dd_name="图书"><span>图书</span></a>
                                        <a href="http://newaccount.dangdang.com/payhistory/03.00.00.00.00.00" dd_name="音像"><span>音像</span></a>
                                        <a href="http://newaccount.dangdang.com/payhistory/05.00.00.00.00.00" dd_name="影视"><span>影视</span></a>
                                        <a href="http://newaccount.dangdang.com/payhistory/98.00.00.00.00.00" dd_name="数字商品"><span>数字商品</span></a>
...
<div class="nav_top">
    <ul>
        <li class="all"><a href="http://category.dangdang.com/?ref=www-0-C" id="a_category" name="cate" class="sort_button" onmouseover="showCategory('a_category','__ddnav_sort','http://static.dangdang.com/js4/header2012/categorydata_new.js?2016092820160906');" onmouseout="closeCategory('__ddnav_sort');" dd_name="全部商品分类" target="_top">全部商品分类</a></li>
...
</script><script src="queryunpaid" type="text/javascript"></script>
	<!-- workarea -->
	
 <div class="mydnew_break">您现在的位置：<a href="http://www.dangdang.com/">当当</a> &gt; <span><a href="http://myhome.dangdang.com/">我的当当</a></span> &gt; <span>账户余额</span> </div> 
...
</li><li><a href="{{ URL('/res') }}" class="on">我的余额</a>
...
</li></ul><h3 class="mydang_left_title">个人中心<a class="slide_up" id="class640" href="javascript:void(click_a('class640','display640'))"></a></h3><ul class="my_content" style="display: block;" id="display640"><li><a class="" target="_parent" href="{{ URL('/infor') }}" name="profileleft">个人信息</a>
...
</li></ul><h3 class="mydang_left_title">社区<a class="slide_up" id="class650" href="javascript:void(click_a('class650','display650'))"></a></h3><ul class="my_content" style="display: block;" id="display650"><li><a class="" target="_parent" href="{{ URL('/disc') }}" name="myreview">评论/晒单</a>
...
<div id="callbackjs"><script src="doccallbackjs.aspx" type="text/javascript"></script></div>
  ...
  document.domain = "dangdang.com";
		...
		<!-- right -->
		<div class="mydang_right">
			<div id="data_filed">

<h1 class="page_title">账户余额</h1>
<div id="comm_sm" class="mydang_right"><div class="r_box col2"><span class="icon"></span><p class="r_box_lev"><span>安全度</span><span class="lev_type"><span></span><i></i></span><span class="c">中</span></p><p class="r_box_meg"><a id="not_remind" href="javascript:void(0);" class="right_btn">7天内不提示</a><span>验证邮箱可以更好的保护您的账户安全，建议您</span><a href="http://safe.dangdang.com/safe.php" target="_top" class="left_btn">立即验证邮箱</a><span>并</span><a style="color: rgb(26, 102, 179);" href="http://safe.dangdang.com/safe.php" target="_top">设置支付密码</a><span>以提升账户安全评级！</span></p></div></div>
<div class="clearfix">
	<div class="balance_box">
		<div class="balance_top">
			
			<p class="balance_mon clearfix">
				<label for="">账户余额</label>
				
				
				<span class="C_f60">￥0</span>
				
			</p>
			<p class="balance_mon clearfix">
				<label for="">不可用余额</label>
		...
		<div class="balance_bottom">
			<p class="first">请注意</p>
			<p>1.账户余额是您在当当留下的现金</p>
			<p>2.在订单结算时，您可根据需要自行选择使用您的账户余额</p>
		</div>
	</div>

</div>
<div class="right_list">
	<h2 class="title">账户余额交易明细</h2>
	
	
		<div class="right_null">暂无交易记录~<span class="null_icon"></span></div>
		...
		<div class="security_center_pop" style="display: none;" id="div_paysecurity_tip">
			<h3>
				设置支付密码<a href="javascript:hideById('div_paysecurity_tip');">close</a>
			</h3>
			<span class="icon"></span>
			<div class="security_center_info">
				<p class="security_center_msg">温馨提示：为了更好的保护您的账户信息及在
					支付过程中的资产安全，请您设置支付密码！</p>
				<p class="success_pop_btn">
					<a href="javascript:GoToPaySercurity();" class="btn btn_orange">立即设置</a>
				</p>
			</div>
		</div>
	</div>
...
<div class="footer" dd_name="页尾">
	...
	<!-- 有三个icon的时候加footer_icon2 -->
		<div class="footer_icon footer_icon2">
				<div class="validator"><a href="http://www.hd315.gov.cn/beian/view.asp?bianhao=010202001051000098" target="_top" class="footer_img"><img src="{{ asset('image4/validate.gif') }}"></a></div>
				<div class="knet"><!-- 可信网站LOGO安装开始 -->
					...
					<a href="https://ss.knet.cn/verifyseal.dll?sn=2010091900100002234&amp;pa=2940051" tabindex="-1" id="urlknet" target="_top" rel="nofollow"><img alt="可信网站" name="CNNIC_seal" src="{{ asset('image4/knetseallogo.png') }}" oncontextmenu="return false;" onclick="CNNIC_change('urlknet')" border="true" height="47" width="128"></a><!-- 可信网站LOGO安装结束 -->
					</div>
					<div class="clear"></div>
				</div>
	</div>
...
<!--CreateDate  2016-09-28 11:00:01-->    <div class="foot_tip_ad">广告</div>
    
<script src="js4/check_snbrowse.js" type="text/javascript"></script>
<script type="text/javascript">login_session.browsePageOperate();</script>
<script src="js4/utopia.js" type="text/javascript"></script>
<script type="text/javascript" src="js4/js_tracker.js"></script>
<script type="text/javascript">
//MediaV
var _mvq = _mvq || [];
...
mvl.src = ('https:' == document.location.protocol ? 'http://static.dangdang.com/js4/header2012/mvl.js' : 'http://static.dangdang.com/js4/header2012/mvl.js');
...
<script src="js4/jquery-1.7.2.min.js" type="text/javascript"></script>
<script src="js4/jquery.cookie.js" type="text/javascript"></script>
<script src="js4/ajax.js" type="text/javascript" charset="gbk"></script>
<script src="js4/commonrecommendjs.js" type="text/javascript" charset="gbk"></script>
<script type="text/javascript" src="getjs.php"></script><script type="text/javascript" charset="gbk" src="js4/adall.min.js"></script>
<script type="text/javascript">
	DD_AD.fetchCPC(9, 0, '', 1, 'new', 'pers');
	CommonRecommend_Ajax();
</script>
