...
<head>
    ...
    <script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="jquery" src="./js/jsh/jquery-1.8.0.min.js"></script>
    <script src="./js/jsh/pagetop2015_0827.js" charset="gb2312" type="text/javascript"></script>
</head>
...
<div class="tools">
  ...
  <li><a target="_blank" href="http://chuban.dangdang.com/" name="mydd_7" dd_name="当当自出版">当当自出版</a></li>
        ...
        <li class="my_dd"><a class="menu_btn" target="_blank" href="{{ URL('/geren')}}" name="我的当当" dd_name="我的当当" id="a_myddchannel" onmouseover="showgaoji('a_myddchannel','__ddnav_mydd')" onmouseout="hideotherchannel('a_myddchannel','__ddnav_mydd');">我的当当</a>
...
<script type="text/javascript">var nick_num = 1;initHeaderOperate();</script><script type="text/javascript" src="queryunpaid.htm"></script>
 ...
 <div class="center">
    ...
    <!-- 右侧快捷功能按钮 end -->
    <script type="text/javascript" src="./js/jsh/js_tracker.js"></script>
    <script type="text/javascript">
        var require = {urlArgs: "v=1471255964930"}
    </script>
    <script type="text/javascript" src="./js/jsh/require.min.js" data-main="recharge_methord"></script>
    <script>
        require.config({
　　　　　　baseUrl: "js/",
　　　　　　paths: {
