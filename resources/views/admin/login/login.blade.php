...
<link href="{{ asset('admins/lib/Hui-iconfont/1.0.7/iconfont.css') }}" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
        @if(session('msg'))
           <p class="login-box-msg" style="color:red;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            {{ session('msg') }}</p>
        @else
           <p class="login-box-msg">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    ...
    <form class="form form-horizontal" action="{{ url('admin/dologin') }}" method="post">
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input id="" name="name" type="text" placeholder="账户名" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="{{ url('admin/captcha/time()') }}" onclick="this.src='{{ url('admin/captcha') }}/'+Math.random()"> <a id="kanbuq" href="javascript:;"></a> </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
