...
<div class="page-container">
	<form class="form form-horizontal" method='post' id="form-article-add" action="{{ '/admin/system-base/add' }}">
	<!-- <input type='hidden' name='method' value='put'/> -->
	<input type='hidden' name='_token' value='{{ csrf_token() }}'/>	
		<div id="tab-system" class="HuiTab">
			<div class="tabBar cl"><span>基本设置</span><span style='display:none'>安全设置</span><span style='display:none'>邮件设置</span style='display:none'><span style='display:none'>其他设置</span></div>
			<div class="tabCon">
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>网站名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="website-title" placeholder="控制在25个字、50个字节以内" value="" class="input-text" name="title">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>关键词：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="website-Keywords" placeholder="5个左右,8汉字以内,用英文,隔开" value="" class="input-text" name="keyword">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>描述：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="website-description" name="des" placeholder="空制在80个汉字，160个字符以内" value="" class="input-text">
					</div>
				</div>
				...
				<div class="row cl" >
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="website-copyright" name="copyright" placeholder="&copy; 2016 H-ui.net" value="" class="input-text">
					</div>
				</div>
				<div>
					<label class="form-label col-xs-4 col-sm-2"><span>网站开关&nbsp:</span>
					<div class="formControls col-xs-8 col-sm-9">
				...
				<div>
					<div class="formControls col-xs-4 col-sm-4">
						关<input type="radio" name='switch' value='0' >&nbsp&nbsp&nbsp&nbsp
						开<input type="radio" name='switch' value='1' >
					</div>	
				</div>
				<div style='display:none' class="row cl" style='display:none'>
