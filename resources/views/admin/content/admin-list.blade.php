...
<body>
	<form action="{{ url("admin/admin-list") }}" method='post' name='myform' style='display:none;'>
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_add('添加管理员','{{ url('admin/admin-list/create') }}','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> 
					<a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','{{ url("admin/admin-list/$admin->id/edit") }}','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
					<a title="删除" href="javascript:doDel({{ "$admin->id" }})"><i class="Hui-iconfont">&#xe6e2;</i></a>
					<!-- <a title="删除" href="javascript:;" onclick="admin_del(this,'{{ url("admin/admin-list/$admin->id") }}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a> -->
				</td>
				<!-- <td>
					<a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加角色','{{ url('admin/admin-role-add') }}','800')">
...
function doDel(id)
{
	if(confirm("确定删除吗？")){
		...
		//提交地址=》由页面提交到-》控制器中的方法去处理删除
		myform.action = '{{ url("admin/admin-list/$admin->id") }}';
		myform.submit();
	}
}
...
/*function admin_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		...
		// var form = document.myform;
		// //提交地址=》由页面提交到-》控制器中的方法去处理删除
		// myform.action = 'admin/admin-list/'+id;
		// myform.submit();
