		...
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				@foreach($list as $row)
					 ...
					 <tr class="text-b va-m">
						<td><input type='checkbox' name='' ></td>
						<td>{{ $row->id }}</td>
						<td>@if($row->pid==0)<h3>{{$row->name}}</h3>@else{{ $row->name }}@endif</td>
						<td class="text-l"><a style="text-decoration:none" onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;">{{ $row->name}}</td>
						<td class="text-l">@if($row->pid==0)@else{{ $row->name }}@endif</td>
						<td><span class="price">356.0</span> 元/平米</td>
						<td class="td-status"><span class="label label-success radius">已发布</span></td>  
						<!--<td class="td-manage"><a style="text-decoration:none" onClick="product_stop(this,'10001')" href="/product-list/{{ $row->id }}" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="product_edit('产品编辑','product-add.html','10001')" href="/product-list/edit/{{ $row->id }}"title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="product_del(this,'10001')" href="/admin/product-list/del/{{ $row->id }}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>-->
	<td class="td-manage">  <a style="text-decoration:none" class="ml-5" onClick="product_del(this,'10001')" href="/admin/product-list/del/{{ $row->id }}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					</tr> 
