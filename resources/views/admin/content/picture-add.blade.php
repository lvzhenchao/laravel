...
<div class="page-container">
	<form method='POST' action='/test' enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
		<input type="hidden" name="_token" value="{{ csrf_token()}}">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>书名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="bookname">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">作者：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="writer">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box">
					...
					<select name='cid' onChange='doChange(this.value)'>
						<option>--请选择--</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="" name="pagenum">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">字数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="wordnum">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="isdn">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="pubtime">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				上架<input type="radio" class="input-text"  name="onsale" value='1'> 	下架<input type="radio" class="input-text"  name="onsale" value='0'>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="brief" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"></textarea>
				<p class="textarea-numberbar"><em class="textarea-length">0</em>/200</p>
			</div>
		</div>
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">上传：</label>
			<div class="formControls col-xs-8 col-sm-9">
