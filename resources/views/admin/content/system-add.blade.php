...
<div class="page-container">
	<form class="form form-horizontal" method='post' id="form-article-add" action="{{ '/admin/url/add' }}">
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="website-title" placeholder="" value="" class="input-text" name="name">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>URL地址：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="website-Keywords" placeholder="http://" value="" class="input-text" name="url">
					</div>
				</div>
				<!-- <div class="row cl">
				...
				<div>
					<div class="formControls col-xs-4 col-sm-4">
						开<input type="radio" name='switch' value='0' >&nbsp&nbsp&nbsp&nbsp
						关<input type="radio" name='switch' value='1' >
					</div>	
				</div>
