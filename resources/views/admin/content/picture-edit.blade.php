...
<script type="text/javascript">
		var city = new Array();
		city[1] = ['文学','艺术','传记','青春文学'];
		city[2] = ['管理','投资理财','经济','成功励志'];
		city[3] = ['社会科学','心理学','法律'];
		city[4] = ['两性关系','育儿早教','亲子家教'];
		function doChange(ob)
		{
			// 获取市下拉框
			...
			sid.length = 1;
			//遍历对应城市
			for (var i = 0; i < city[ob].length; i++) {
				//生成一个选项对象
				var opt = new Option(city[ob][i],city[ob][i]);
				//把这个对象添加到select中
				sid.add(opt);
			}
		}
...
<body>
<div>
<img src="{{ asset( $list->pic)  }}"  >


</div>		

<div class="page-container">
	<form method='post' action={{ url('admin/product/doedit') }} enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="bookname" value="{{ $list->bookname }}">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">作者：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="writer" value="{{ $list->author }}">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box">
					...
					<select name='cid'  id='cid' onChange='doChange(this.value)'>
						<option   >--请选择--</option>
						<option value='1'>文艺</option>
						<option value='2'>经管</option>
						<option value='3'>社科</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="publish" value="{{ $list->publish }}">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">页数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="" name="pagenum" value="{{ $list->pagenum }}">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">字数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="wordnum" value="{{ $list->wordnum }}">
			</div>
		</div>
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">ISDN：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="isdn" value="{{ $list->isdn }}">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="pubtime" value="{{ $list->pubtime }}">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="price" value="{{ $list->newprice }}">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="brief" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)">{{ $list->brief }}"</textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="file" class="input-text" value="上传" name='mypic'>
			</div>
		</div>
...
<script type="text/javascript" src="{{ asset('admins/lib/jquery.validation/1.14.0/jquery.validate.min.js') }}"></script> 
<script type="text/javascript" src="{{ asset('admins/lib/jquery.validation/1.14.0/validate-methods.js') }}"></script> 
<script type="text/javascript" src="{{ asset('admins/lib/jquery.validation/1.14.0/messages_zh.min.js') }}"></script> 
...
<script type="text/javascript" src="{{ asset('admins/static/h-ui.admin/js/comment.js') }}"></script>
<!--/_footer /作为公共模版分离出去-->
