...
<div class="page-container">
  <div>
    <textarea class="textarea" style="width:98%; height:300px; resize:none">
    	她妈|它妈|他妈|你妈|去死|贱人|1090tv|10jil|21世纪中国基金会|2c8|3p|4kkasi|
    	64惨案|64惨剧|64学生运动|64运动|64运动民國|89惨案|89惨剧|89学生运动|89运动|
    	adult|asiangirl|avxiu|av女|awoodong|A片|bbagoori|bbagury|bdsm|binya|bitch|
    	bozy|bunsec|bunsek|byuntae|B样|fa轮|fuck|ＦｕｃΚ|gay|hrichina|jiangzemin|j女|
    	kgirls|kmovie|lihongzhi|MAKELOVE|NND|nude|petish|playbog|playboy|playbozi|pleybog|
    	pleyboy|q奸|realxx|s2x|sex|shit|sorasex|tmb|TMD|tm的|tongxinglian|triangleboy|UltraSurf|
    	unixbox|ustibet|voa
    </textarea>
  </div>
...
<script type="text/javascript" src="{{ asset('admins/lib/layer/2.1/layer.js') }}"></script><script type="text/javascript" src="{{ asset('admins/lib/laypage/1.2/laypage.js') }}"></script> 
...
<script type="text/javascript" src="{{ asset('admins/js/H-ui.admin.system.js') }}"></script>
<script>
var _hmt = _hmt || [];
(function() {
