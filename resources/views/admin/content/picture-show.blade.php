		...
		<ul class="cl portfolio-area">
			<li class="item">
				<div class="portfoliobox">
					...
					<div class="picbox"><a href="{{ asset('admins/temp/big/keting.jpg') }}" data-lightbox="gallery" data-title="客厅1"><img src="{{ asset('admins/temp/Thumb/keting.jpg') }}"></a></div>
			...
			<li class="item">
				<div class="portfoliobox">
					<input class="checkbox" name="" type="checkbox" value="">
					<div class="picbox "><a href="{{ asset('admins/temp/big/keting2.jpg') }}" data-lightbox="gallery" data-title="客厅2"><img src="{{ asset('admins/temp/Thumb/keting2.jpg') }}"></a></div>
					<div class="textbox">客厅 </div>
				</div>
			</li>
			<li class="item">
				<div class="portfoliobox">
					<input class="checkbox" name="" type="checkbox" value="">
					<div class="picbox"><a href="{{ asset('admins/temp/big/keting3.jpg') }}" data-lightbox="gallery" data-title="客厅3"><img src="{{ asset('admins/temp/Thumb/keting3.jpg') }}"></a></div>
					<div class="textbox">客厅 </div>
				</div>
			</li>
			<li class="item">
				<div class="portfoliobox">
					<input class="checkbox" name="" type="checkbox" value="">
					<div class="picbox"><a href="{{ asset('admins/temp/big/keting4.jpg') }}" data-lightbox="gallery" data-title="客厅4"><img src="{{ asset('admins/temp/Thumb/keting4.jpg') }}"></a></div>
					<div class="textbox">客厅 </div>
				</div>
			</li>
			<li class="item">
				<div class="portfoliobox">
					<input class="checkbox" name="" type="checkbox" value="">
					<div class="picbox"><a href="{{ asset('admins/temp/big/chufang.jpg') }}" data-lightbox="gallery" data-title="厨房"><img src="{{ asset('admins/temp/Thumb/chufang.jpg') }}"></a></div>
			...
			<li class="item">
				<div class="portfoliobox">
					<input class="checkbox" name="" type="checkbox" value="">
					<div class="picbox"><a href="{{ asset('admins/temp/big/shufang.jpg') }}" data-lightbox="gallery" data-title="书房"><img src="{{ asset('admins/temp/Thumb/shufang.jpg') }}"></a></div>
			...
			<li class="item">
				<div class="portfoliobox">
					<input class="checkbox" name="" type="checkbox" value="">
					<div class="picbox"><a href="{{ asset('admins/temp/big/woshi.jpg') }}" data-lightbox="gallery" data-title="卧室"><img src="{{ asset('admins/temp/Thumb/woshi.jpg') }}"></a></div>
			...
			<li class="item">
				<div class="portfoliobox">
					<input class="checkbox" name="" type="checkbox" value="">
					<div class="picbox"><a href="{{ asset('admins/temp/big/weishengjian.jpg') }}" data-lightbox="gallery" data-title="卫生间1"><img src="{{ asset('admins/temp/Thumb/weishengjian.jpg') }}"></a></div>
			...
			<li class="item">
				<div class="portfoliobox">
					<input class="checkbox" name="" type="checkbox" value="">
					<div class="picbox"><a href="{{ asset('admins/temp/big/weishengjian2.jpg') }}" data-lightbox="gallery" data-title="卫生间2"><img src="{{ asset('admins/temp/Thumb/weishengjian2.jpg') }}"></a></div>
...
<script type="text/javascript" src="{{ asset('admins/lib/lightbox2/2.8.1/js/lightbox-plus-jquery.min.js') }}"></script> 
