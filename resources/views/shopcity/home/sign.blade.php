			...
			<div class="shadow_box" style="margin-left:100px;">
				<div class="register_box">
					<div class="head">
						...
						<a href="https://login.dangdang.com/register_company.php?returnurl=http://e.dangdang.com/index_page.html" class="head_a">企业用户注册</a>
					</div>
					<div class="body">
						...
						<table width="100%" cellspacing="0" cellpadding="0" border="0">
							<tbody><tr>
								...
								<td class="z_index2">
									<input name="txt_username" id="txt_username" autocomplete="off" maxlength="40" tabindex="1" value="" placeholder="请输入您的邮箱或手机号码" class="text" type="text"><span id="spn_username_ok" class="icon_yes" style="display: none;"></span>
									<span id="J_tipUsername" class="cue warn">邮箱/手机号可用于登录、找回密码、接收订单通知等服务</span>
							...
							<tr>
								<td class="t">登录密码</td>
								<td>
									<input name="txt_password" id="txt_password" onpaste="return false;" tabindex="2" class="text" maxlength="20" type="password">
							...
							<tr>
								...
								<td class="j-vcode">
									<input class="text pin" id="txt_vcode" name="txt_vcode" autocomplete="off" placeholder="请输入验证码" maxlength="4" tabindex="5" type="text">
									<a class="code_pic" id="vcodeImgWrap" name="change_code_img" href="javascript:void(0);">
										<img id="imgVcode" title="点击更换验证码" alt="点击更换验证码" src="./images/tmp_proxy.php" height="37" width="84">
									</a>
