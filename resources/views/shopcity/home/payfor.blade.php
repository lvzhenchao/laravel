...
<head>
    ...
    <script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="recharge_methord" src="./js/recharge_methord.js"></script>
    ...
    <script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="underscore" src="./js/underscore.min.js"></script>
</head>
            ...
            <div class="recharge_main">
                <div class="row noTopBorder">
                    ...
                    <ul class="clearfix methord">
                        <li onclick="fun(this)"><span><input name="recharge_methord" data-paymentid="1018" type="radio"></span><span class="img_area"><img src="./images/zhifubao_pay_icon.png" alt=""></span></li>
                        <script type="text/javascript">
                            $(function fun(obj){
                ...
                <div id="getDepositShowView">
                    <div class="row">
                        ...
                        <ul class="clearfix value">
                                ...
                                <li data-relationproductid="1900411317"><p class="bell_num"><em>500</em>金铃铛</p>
                                <p class="rmb">￥5.00</p>
